...
$('#page .list-group:gt(' + (limitPerPage - 1) + ')').hide(); // Hide all items over page limits
var totalPages = Math.ceil(numberOfItems / limitPerPage); // Get number of pages
$(".pagination").append("<li class='current-page active'><a href='#' style='padding: 5px 13px 5px 13px !important'>" + 1 + "</a></li>"); // Add first page marker
...
$(".pagination").append("<li id='next-page'><a href='#' aria-label=Next><span aria-hidden=true><i class='fa-solid fa-angle-right'></i></span></a></li>");
